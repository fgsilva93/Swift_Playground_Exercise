 ...
 */
let listOfFamilyNames = ["Franco", "Gerardo", "Lalo", "Alina", "Hershey", "Diana", "Teofilo"]
let sortedCollection1 = listOfFamilyNames.sorted(by: forwards)
 ...
 */
let sortedCollection2 = listOfFamilyNames.sorted(by: { (name1, name2) -> Bool in
    print(name1)
    print(name2)
 ...
 */
let sortedCollection3 = listOfFamilyNames.sorted(by: {
    print($0)
    print($1)
