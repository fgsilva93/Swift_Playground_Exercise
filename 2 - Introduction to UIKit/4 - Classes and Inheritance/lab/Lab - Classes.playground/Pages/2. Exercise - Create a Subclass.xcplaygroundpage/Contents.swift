...
class Fighter: Spaceship {
    var weapon: String = ""
    var remianingFirePower: Int = 5
    
    func fire () {
        if remianingFirePower > 0 {
            remianingFirePower -= 1
...
destroyer.remianingFirePower = 10
 ...
 */
//print(falcon.weapon)
// it didnt work due to the class spaceship not able to inheirt the properties of its subclass?
 ...
 */
destroyer.fire()
print(destroyer.remianingFirePower)
destroyer.fire()
print(destroyer.remianingFirePower)
destroyer.fire()
print(destroyer.remianingFirePower)
