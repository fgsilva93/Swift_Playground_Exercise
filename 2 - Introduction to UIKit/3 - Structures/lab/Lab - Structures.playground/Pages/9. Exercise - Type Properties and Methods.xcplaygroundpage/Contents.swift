...
struct User {
    ...
    var email: String
    var age: Int
    static var currentUser = User(userName: "Franco", email: "someemail123@gmail.com", age: 27)
    
    static func logIn(user: User) {
        currentUser = user
        print("\(currentUser.userName) is logged in now.")
    }
}
 ...
 */
var someUser = User(userName: "Sam", email: "sam12@gmail.com", age: 26)
