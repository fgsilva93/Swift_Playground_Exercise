...
let workoutMath = RunningWorkout(distance: 3600, time: 25.00, elevation: 5.0)
print(workoutMath.averageMileTime)
/*:
...
struct Steps {
    var steps: Int {
        willSet {
            if newValue == goal {
                print("Congrats, you met your goal!")
            }
        }
    }
    var goal: Int
...
var newSteps = Steps(steps: 9999, goal: 10000)
