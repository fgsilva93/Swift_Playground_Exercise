...
// because the variable foo is a value that only exist within the for loop, and accessing it out =side lets to problems
/*:
...
// in this example the reason why u can print the valuw x is because that value exist outside of the for loop.
/*:
